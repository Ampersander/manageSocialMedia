 ...
 */
final class Version20210322092039 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post_social_media_account (post_id INT NOT NULL, social_media_account_id INT NOT NULL, INDEX IDX_10652499E5E06EE3 (social_media_account_id), INDEX IDX_106524994B89032C (post_id), PRIMARY KEY(post_id, social_media_account_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
